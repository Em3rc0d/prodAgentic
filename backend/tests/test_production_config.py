...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("FRONTEND_URL", "https://app.prodagentic.example/", "origin only"),
        ("FRONTEND_URL", "https://app.prodagentic.example/path", "origin only"),
        ("CORS_ALLOWED_ORIGINS", "*", "must not contain"),
        ("CORS_ALLOWED_ORIGINS", "https://*.prodagentic.example", "must not contain"),
        ("CORS_ALLOWED_ORIGINS", "http://app.prodagentic.example", "HTTPS origin"),
        ("CORS_ALLOWED_ORIGINS", "https://app.prodagentic.example/", "origin only"),
